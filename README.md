...
> **Chat Interface:** Use [**OrionBelt Chat**](https://github.com/ralfbecher/orionbelt-chat) as an AI-powered chat UI for OrionBelt Analytics and Semantic Layer. Built with Chainlit and Pydantic AI, it supports multiple LLM providers (OpenRouter, MLX, Ollama) and connects to both MCP servers for conversational database analysis, ontology generation, and interactive data visualization.
